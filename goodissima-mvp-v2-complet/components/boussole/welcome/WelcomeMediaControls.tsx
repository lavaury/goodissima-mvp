  ...
  return (
    <section className="rounded-xl bg-slate-50 px-4 py-4 sm:px-5" aria-labelledby="welcome-media-title">
      ...
      <div className="mt-3 flex flex-col items-start gap-3 sm:flex-row sm:flex-wrap sm:items-center">
        ...
        {audioState === "playing" ? <><button type="button" onClick={onPauseAudio} className="min-h-11 rounded-lg border bg-white px-4 py-2 text-sm font-bold focus-visible:ring-2 focus-visible:ring-cyan-700">Pause</button><button type="button" onClick={onStopAudio} className="min-h-11 rounded-lg border bg-white px-4 py-2 text-sm font-bold focus-visible:ring-2 focus-visible:ring-cyan-700">Arrêter</button></> : null}
