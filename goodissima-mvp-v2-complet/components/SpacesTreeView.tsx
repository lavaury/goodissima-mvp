...
type Workspace = SpacesTree["roots"][number];
function WorkspaceRow({ workspace, first }: { workspace: Workspace; first: boolean }) {
  return <li data-boussole-id={first ? "governance-first-workspace" : undefined} className="min-w-0 rounded-xl border bg-white p-3 sm:p-4">
