...
const contexts: CompassContext[] = [
  ...
  { id: "governance", pageName: "Comprendre Mes espaces", summary: "Retrouvez vos Portfolios et vos Workspaces dans leur organisation actuelle.", caution: "Ouvrir un espace ne lance aucune action automatiquement.", steps: governanceSteps },
  ...
  { id: "opportunities", pageName: "Gérer les opportunités", summary: "Cette collection rassemble ce que vous recherchez ou proposez, avec son statut courant.", caution: "Recherchez ou filtrez une opportunité pour l’ouvrir. Aucune publication ni action n’est automatique.", steps: opportunitySteps },
