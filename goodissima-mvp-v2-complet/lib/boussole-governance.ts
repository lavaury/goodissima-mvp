...
export const governanceSequences: BoussoleSequence[] = [
  ...
  { id: "understand-workspaces", title: "Organiser mes espaces", description: "Comprendre la hiérarchie et ouvrir un espace réel.", applicableStates: ["EMPTY", "POPULATED"], steps: [
    ...
    step("spaces-open-workspace", "open-workspace", "Ouvrir le Workspace", "Ouvrez le Workspace pour retrouver Piloter, Explorer et sa création contextualisée. Le bouton ••• donne accès aux actions de l’objet ; vous pouvez aussi faire un clic droit sur sa ligne pour ouvrir le même menu. La Boussole ne l’ouvre pas à votre place.", { glossary: ["workspace", "validation-humaine"] }),
  ] },
  { id: "organize-unassigned", title: "Organiser les éléments sans Workspace", description: "Comprendre le rattachement manuel d’objets qui existent déjà.", applicableStates: ["POPULATED"], steps: [
    ...
    step("unassigned-no-workspace", "no-workspace-available-for-attachment", "Aucun Workspace disponible", "Aucune destination n’est disponible sur cette page. Consultez les autres pages de Workspaces ou créez un Workspace.", { glossary: ["workspace"] }),
    step("unassigned-none", "no-unassigned-governed-journeys", "Aucun parcours sur cette page", "Cette page ne présente aucun parcours à organiser. Les commandes de pagination permettent de consulter les autres pages disponibles.", { glossary: ["workspace", "parcours-gouverne"] }),
    ...
    step("unassigned-attach-case", "attach-relational-case-to-workspace", "Confirmer le rattachement", "Cette action rattache le dossier et, si nécessaire, son lien parent propriétaire sans Workspace, comme indiqué avant confirmation. Elle conserve les accès existants.", { glossary: ["rattachement-manuel", "acces-candidat", "validation-humaine"] }),
    step("unassigned-no-cases", "no-unassigned-relational-cases", "Aucun dossier sur cette page", "Cette page ne présente aucun dossier à organiser. Les commandes de pagination permettent de consulter les autres pages disponibles.", { glossary: ["dossier-relationnel", "workspace"] }),
  ] },
];
