...
export const governanceSequences: BoussoleSequence[] = [
  { id: "understand-governance", title: "Comprendre Gouvernance", description: "Comprendre la mission de cette page et sa différence avec un lien simple.", applicableStates: ["EMPTY", "POPULATED"], steps: [
  ...
  { id: "governance-summary", title: "Lire la synthèse", description: "Lire les indicateurs réellement disponibles et l’état vide.", applicableStates: ["EMPTY", "POPULATED"], steps: [
  ...
  { id: "create-governed", title: "Créer un parcours gouverné", description: "Comprendre quand utiliser le constructeur de parcours.", applicableStates: ["EMPTY", "POPULATED"], steps: [
  ...
  { id: "understand-workspaces", title: "Organiser mes espaces", description: "Distinguer Workspaces, Portfolios et Annuaire, puis utiliser leurs accès réels.", applicableStates: ["POPULATED"], steps: [
    ...
    step("governance-open-portfolios", "governance-first-portfolio", "Consulter mon premier Portfolio", "Cette première carte réelle présente un Portfolio qui regroupe vos Workspaces. Un Portfolio organise des espaces existants et ne remplace pas le Workspace.", { glossary: ["portfolio", "workspace"] }),
  ...
  { id: "read-governed-journey", title: "Lire et ouvrir un parcours", description: "Utiliser le premier parcours gouverné réel visible.", applicableStates: ["POPULATED"], steps: [
  ...
  { id: "governance-pilotage", title: "Accéder au pilotage", description: "Distinguer la Salle globale du cockpit d’un parcours.", applicableStates: ["POPULATED"], steps: [
