...
export const mockAIProvider: AIProvider = {
  ...
  async chat(request: AIProviderRequest): Promise<AIProviderResult<string>> {
    if (request.metadata?.capability === "interpretHomeIntent") {
      return { provider: "mock", model: this.model, output: JSON.stringify({ intent: "UNKNOWN", reformulation: "Je ne suis pas certain d'avoir compris votre demande.", confidenceBand: "LOW", proposedParameters: {} }) };
    }
