...
export const dossierSequences: BoussoleSequence[] = [
  { id: "understand-secure-case", title: "Comprendre ce dossier sécurisé", description: "Voir ce qui est créé après une réponse ou une mise en relation acceptée.", steps: [
    ...
    step("case-next-action", "case-next-action", "À faire maintenant", "Cette zone indique une seule priorité déterminée à partir de l’état réel du dossier, sans décision ni action automatique.", { glossary: ["dossier-relationnel", "validation-humaine"] }),
    step("case-next-action-why", "case-next-action-why", "Comprendre la priorité", "Ouvrez Pourquoi pour voir le fait du dossier qui justifie la priorité affichée.", { glossary: ["validation-humaine"] }),
    step("case-next-action-follow-ups", "case-next-action-follow-ups", "À suivre", "Cette liste courte conserve les autres repères utiles sans concurrencer l’action principale.", { glossary: ["dossier-relationnel"] }),
    step("case-next-action-assistance", "case-next-action-assistance", "Assistance séparée", "L’analyse et le résumé restent des aides distinctes. Ils ne modifient pas le dossier sans validation humaine.", { glossary: ["validation-humaine"] }),
  ] },
