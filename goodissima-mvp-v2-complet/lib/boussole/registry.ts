...
const journeyVersions: Record<string, number> = {
  ...
  "create-manually": 3,
  "review-journey-proposal": 2,
  "discover-before-creating": 2,
  "documents-actions": 2,
  "verify-create": 2,
  "understand-secure-case": 2,
  "create-opportunity-draft": 2,
  "discover-opportunities": 2,
...
export const boussoleRegistry: BoussoleRegistryEntry[] = [
  ...
  registerPage("opportunities", ["/opportunities"], opportunitySequences),
];
