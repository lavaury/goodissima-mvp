...
export const governedJourneySequences: BoussoleSequence[] = [
  { id: "discover-governed-journey", title: "Découvrir ce parcours gouverné", description: "Comprendre le cadrage réel, le Workspace, la synthèse et les compteurs.", applicableStates: ["FOCUSED"], steps: [
  ...
  { id: "governance-review", title: "Revue de gouvernance", description: "Comprendre la préparation, l’assistance facultative et la conduite humaine.", applicableStates: ["FOCUSED"], steps: [
