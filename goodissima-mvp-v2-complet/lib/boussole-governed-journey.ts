...
export const governedJourneySequences: BoussoleSequence[] = [
  { id: "discover-governed-journey", title: "Découvrir ce parcours", description: "Comprendre son contexte, sa situation et ce qui demande votre attention.", applicableStates: ["FOCUSED"], steps: [
    ...
    step("real-journey-summary", "governed-journey-summary", "Où en sommes-nous ?", "Cette synthèse humaine indique la situation réelle du parcours sans exposer ses détails techniques et sans décider à votre place.", { glossary: ["contexte", "signal"] }),
    step("real-journey-now", "governed-journey-human-interventions", "À faire maintenant", "Cette zone présente uniquement les actions actuellement pertinentes. Montrer la zone ne déclenche aucune de ces actions.", { glossary: ["signal", "responsabilite"] }),
  ...
  { id: "participants-access", title: "Participants, invitations et accès", description: "Lire les responsabilités et les accès réellement préparés.", applicableStates: ["FOCUSED"], steps: [
    ...
    step("real-participants", "governed-journey-participants", "Personnes et rôles", "Cette section distingue les personnes qui participent réellement au parcours des rôles qui restent à pourvoir. Aucun message n’est transmis automatiquement.", { glossary: ["participant", "responsabilite"] }),
  ...
  { id: "documents-actions", title: "Documents et premières actions", description: "Comprendre les attentes documentaires et les actions restant humaines.", applicableStates: ["FOCUSED"], steps: [
  ...
  { id: "governed-communications", title: "Communications gouvernées", description: "Lire les états réels et le périmètre des participants autorisés.", applicableStates: ["FOCUSED"], steps: [
