...
const sourceSelect = { id: true, kind: true, status: true, title: true, authoredAt: true, receivedAt: true, recordedAt: true, visibilityPolicyRef: true, unavailableReason: true } satisfies Prisma.GovernedMemorySourceSelect;
