...
export const ROLE_PERMISSIONS: Readonly<Record<GovernedMemoryRole, readonly GovernedMemoryPermission[]>> = {
  RELATION_CASE_OWNER: ["VIEW_MEMORY", "VIEW_SOURCES", "REGISTER_SOURCE", "PROPOSE_FACT", "DISPUTE_FACT", "RECORD_DECISION"],
  MEMORY_STEWARD: ["VIEW_MEMORY", "REGISTER_SOURCE", "PROPOSE_FACT", "ESTABLISH_FACT", "DISPUTE_FACT", "RECORD_DECISION", "VALIDATE_DECISION", "VALIDATE_SYNTHESIS", "MANAGE_MEMORY_ACCESS", "PROMOTE_PRIVATE_SOURCE"],
  MEMORY_DELEGATE: ["VIEW_MEMORY", "REGISTER_SOURCE", "PROPOSE_FACT", "ESTABLISH_FACT", "DISPUTE_FACT", "RECORD_DECISION", "VALIDATE_DECISION", "VALIDATE_SYNTHESIS", "PROMOTE_PRIVATE_SOURCE"],
