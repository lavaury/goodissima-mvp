...
- For GUI work, inspect before acting with screen/window tools as needed.
...
- Prefer existing package scripts over arbitrary command execution. There is no arbitrary remote shell capability.
